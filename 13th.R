# Data
data <- c(1, 1, 5, 5, 5, 5, 5, 8, 8, 10, 10, 10, 10, 12, 14, 14, 14, 15, 15, 
          15, 15, 15, 15, 18, 18, 18, 18, 18, 18, 18, 20, 20, 20, 20, 20, 
          20, 20, 21, 21, 21, 21, 25, 25, 25, 25, 25, 28, 28, 30)
...
par(mfrow=c(3, 1), mar=c(4, 4, 2, 1)) # Set up a 3-row plotting area with adjusted margins
